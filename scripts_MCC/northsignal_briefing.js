 ...
 *
 * v8 (12 sep 2026): el latido pasa al patron try/catch de los demas scripts. Antes
 * latia OK al ARRANCAR, asi que un briefing que fallaba a mitad de camino igual
 * figuraba sano en v_tareas_en_silencio: el latido media el disparo, no el trabajo.
 * ----------------------------------------------------------------------------
 */
...
function main() {
  try { _main(); latir('briefing', true); }
  catch (e) { latir('briefing', false, e.message); throw e; }
}
...
// Registra que este script corrio y si termino bien. Si el briefing deja de correr o
// falla, v_tareas_en_silencio lo detecta en la proxima corrida de otra cosa.
