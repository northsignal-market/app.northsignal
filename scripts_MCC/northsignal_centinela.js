 ...
 */
/**
 * NORTHSIGNAL — CENTINELA INTRADÍA  ·  v14
 * ============================================================================
 ...
 *
 * v14 (12 sep 2026): FRESH_MONKEE queda vinculada al MCC y este script la vigila
 * como a las demás. La copia que corría adentro de la cuenta se desactiva: dos
 * centinelas sobre la misma cuenta duplican eventos y avisos.
 *
 ...
 * ruido y no señal. Y con Fresh Monkee sumada son cuatro cuentas por
 * corrida: 24 corridas diarias serían 96 ejecuciones por día contra las
 * cuotas del MCC, sin ganar nada respecto de correr cada 4 horas.
 *
 ...
 *
 * Deben aparecer LAS CUATRO cuentas, y el gasto en el orden de magnitud
 * real de cada una: cientos de USD en FRESH_MONKEE, cientos de EUR en
 * KAREDO, decenas de miles de CLP en BHI y 360.
 * Si aparece 0,02 el bug del cost() volvió.
 * ================================================================ */
