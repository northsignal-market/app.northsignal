...
- Bandeja: la pantalla de inicio. Una cola con lo que espera el criterio de Andrés, en orden: pide acción hoy, listos para ejecutar, esperan confirmación, reportes para aprobar. Cada fila se abre ahí. Cuando está vacía dice "Nada te espera". Debajo, colapsados: ayer en cada cuenta (una línea por cuenta) y qué pasó después (impacto de cambios a 14 días, predicciones acertadas o falladas).
...
- Al abrir un accionable: Por qué, Cómo hacerlo (pasos en Google Ads), Dónde, y si es negativa o pausa, "Aprobar y que se haga" para que un script lo ejecute en la próxima hora.
