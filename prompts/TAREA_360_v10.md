...
```sql
select latir('tarea_semanal_360', true);
```
...
y el motivo: `select latir('tarea_semanal_360', false, 'qué falló');` Y la última línea de tu respuesta: qué consultaste, qué vino vacío, días provisionales, puntaje.
</salidas>
